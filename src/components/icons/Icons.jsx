...
export const LogoIcon = ({ type = 'podium', className = "w-6 h-6", size = 28 }) => {
  if (type === 'brain') {
    return (
  ...
  // Default: PresAnalyzer / Presentation Evaluator Podium
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <rect width="32" height="32" rx="8" fill="url(#logo_grad)" />
      <path d="M9 22L16 8L23 22H9Z" stroke="#FFFFFF" strokeWidth="2.2" strokeLinejoin="round" />
      <path d="M12 18H20" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" />
      <circle cx="16" cy="14" r="1.5" fill="#FFFFFF" />
      <circle cx="23" cy="10" r="2" fill="#6EE7B7" />
      <defs>
        <linearGradient id="logo_grad" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
          <stop stopColor="hsl(var(--hue-primary), var(--sat-primary), 55%)" />
          <stop offset="1" stopColor="hsl(calc(var(--hue-primary) + 30), 90%, 45%)" />
        </linearGradient>
      </defs>
    </svg>
  );
